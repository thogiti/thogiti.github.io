---
title: Envisioning Ethereum's Future - The Path to Enshrined Proposer-Builder Separation (ePBS)
tags: Ethereum ePBS PBS MEV Proposer-Builder-Separation Enshrined-Proposer-Builder-Separation Enshrined-PBS In-Protocol-PBS
---
...
The discussion around the enshrinement of PBS (ePBS) within Ethereum's protocol has stirred significant debate, with various counterarguments presented by its critics [^3]. Proponents of ePBS, however, offer robust responses to these concerns, advocating for its necessity and integration into Ethereum's roadmap. Additionally, the discourse explores alternative methods for addressing miner extractable value (MEV), weighing their sufficiency against the proposed ePBS system[^3].
...
### [Payload-Timeliness Committee (PTC)](#payload-timeliness-committee-ptc)
...
![PTC Flow for ePBS](/assets/images/20240328/PTC-Flow-ePBS.png)
...
#### [Honest Attesting Behavior](#honest-attesting-behavior)
...
#### [Properties and Potential New Attack Vectors](#properties-and-potential-new-attack-vectors)
...
### [PEPC - Protocol-Enforced Proposer Commitments](#pepc---protocol-enforced-proposer-commitments)
...
#### [Benefits of PEPC](#benefits-of-pepc)
...
#### [Disadvantages of PEPC](#disadvantages-of-pepc)
...
#### [Tradeoffs of Implementation of PEPC](#tradeoffs-of-implementation-of-pepc)
...
#### [How would PEPC work?](#how-would-pepc-work)
...
![PEPC Workflow](/assets/images/20240328/PEPC-workflow.png)
...
#### [Relationship and Differences to EigenLayer](#relationship-and-differences-to-eigenlayer)
